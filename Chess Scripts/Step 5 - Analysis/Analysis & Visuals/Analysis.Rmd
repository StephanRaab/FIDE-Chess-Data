...
ggplot(data = Active_player, aes(x = Date_numeric, y = avg_rating)) + 
  ...
  dark_theme_gray()+
  theme(panel.grid.major = element_line(linetype = 'solid',colour = "white", size = .1), 
        panel.grid.minor = element_line(linetype = 'solid',colour = "white", size = .1))-> p7
...
ggplot(data = Inactive_player, aes(x = Date_numeric, y = avg_rating)) + 
  ...
  dark_theme_gray()+
  theme(panel.grid.major = element_line(linetype = 'solid',colour = "white", size = .1), 
        panel.grid.minor = element_line(linetype = 'solid',colour = "white", size = .1))-> p8
...
ggplot(data = Active_player, aes(x = Date_numeric, y = sd_rating)) + 
  ...
  dark_theme_gray()+
  theme(panel.grid.major = element_line(linetype = 'solid',colour = "white", size = .1), 
        panel.grid.minor = element_line(linetype = 'solid',colour = "white", size = .1))-> p9
...
ggplot(data = Inactive_player, aes(x = Date_numeric, y = sd_rating)) + 
  ...
  dark_theme_gray()+
  theme(panel.grid.major = element_line(linetype = 'solid',colour = "white", size = .1), 
        panel.grid.minor = element_line(linetype = 'solid',colour = "white", size = .1))-> p10
...
geom_hline(aes(yintercept = 0))+
  theme(panel.grid.major = element_line(linetype = 'solid',colour = "white", size = .1), 
        panel.grid.minor = element_line(linetype = 'solid',colour = "white", size = .1))-> p11
...
xlab("Year")+
  theme(panel.grid.major = element_line(linetype = 'solid',colour = "white", size = .1), 
        panel.grid.minor = element_line(linetype = 'solid',colour = "white", size = .1))-> p12
...
xlab("Year")+
  theme(panel.grid.major = element_line(linetype = 'solid',colour = "white", size = .1), 
        panel.grid.minor = element_line(linetype = 'solid',colour = "white", size = .1)) -> p13
...
dark_theme_gray()+
  theme(panel.grid.major = element_line(linetype = 'solid',colour = "white", size = .1), 
        panel.grid.minor = element_line(linetype = 'solid',colour = "white", size = .1))-> p14
...
xlab("Year")+
theme(panel.grid.major = element_line(linetype = 'solid',colour = "white", size = .1), 
      panel.grid.minor = element_line(linetype = 'solid',colour = "white", size = .1)) -> p15
...
ggplot(aes(x= Country, y =n, fill = Country))+
    ...
    theme(legend.position = "none")+
    theme(panel.grid.major = element_line(linetype = 'solid',colour = "white", size = .1), 
          panel.grid.minor = element_line(linetype = 'solid',colour = "white", size = .1)) -> p16
...
ggplot(aes(x= Country, y= average_rating, fill = Country))+
    ...
    theme(legend.position = "none")+
    theme(panel.grid.major = element_line(linetype = 'solid',colour = "white", size = .1), 
          panel.grid.minor = element_line(linetype = 'solid',colour = "white", size = .1)) -> p17
...
ggplot(aes(Age_Birthday, Rating, color=Title)) +
  ...
  ylab("Rating")+
  theme(panel.grid.major = element_line(linetype = 'solid',colour = "white", size = .1), 
        panel.grid.minor = element_line(linetype = 'solid',colour = "white", size = .1)) -> p18
