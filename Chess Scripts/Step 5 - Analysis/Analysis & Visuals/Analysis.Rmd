...
The most relevant of the 3 graphs is `B` which shows several instances where total player counts dropped off. I genuinely don't if the data is faulty because of my doing or if FIDE is providing incomplete datasets based off pf the charts.
...
```{r, echo = FALSE, warning=TRUE, message=TRUE, fig.height=9, fig.width=9, cache=TRUE}
p11
...
```{r, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE, fig.height= 8}
p17 
```
