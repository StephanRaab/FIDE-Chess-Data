...
- Bulgaria, Finland, Germany, Serbia and Montenagro, and the United State of America saw unusual spikes & dips at various junctures (2002, 2007, 2017)
...
This plot would be substantially better at showing relative strengths amnong countries if I could scale it differently. This will adjusted in future iterations, probably through scaling.
...
# Males/Females rating distributions
...
Above is a plot showing the stark difference between male and female rating distributions. I'll look to explore why the female rating distribution is sharply skewed right compared to their male counterparts. 
